...
# Fix for Python audioop module in newer runtime environments (Python 3.13+)
try:
    import audioop
except ImportError:
    try:
...
# Cache for storing music titles recognized by Shazam
MUSIC_CACHE = {}

# Instaloader settings optimized for fast URL extraction
